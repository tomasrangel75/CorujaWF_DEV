...
namespace Prova
{
    public partial class ProvaAluno : Form
    {
        ...
        private string dir;
        private string raiz ="C://Prova";
        private string dbquest = @"\DBQUEST";
                ...
                else
                {
                    if (File.Exists(avalFullPath + "\\DBQUEST"))
                    {
                        ...
                        if (result == 0 || quest == 0)
                        {
                            ...
                            var ava = ctx.Avaliacaos.Find(idAva);
                            if (ava != null) ctx.Avaliacaos.Remove(ava);
                            ctx.SaveChanges();
        ...
        private void CloseMethod()
        {
            ...
            if (alunoAtual != null)
            {
                ...
                string nome = nomeEscola.Replace("_", "") + "_" + nomeTurma.Replace("_", "") + "_" + questionario.Nome.Replace("_", "") + "_" + nomeAluno.Replace("_", "") + "_" +
                ...
                if (form.exportou)
                {
                    ...
                    var a = ctx.Avaliacaos.Find(_idAval);
                    a.Status = "Finalizada";
                    a.DtFim = DateTime.Now;
                    var entry = ctx.Entry(a);
                    ctx.Avaliacaos.Attach(a);
